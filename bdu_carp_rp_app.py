...
#Page header/ logo
st.logo(image='TKasie/BDU-CARP/index2.png', icon_image='TKasie/BDU-CARP/index2.png')   
...
gdf_file_path = 'TKasie/BDU-CARP/rmetric_gdf.shp'
@st.cache_data
...
data = pd.read_csv('BDU-CARP-main/data_top_bad_good_years_by_uai.csv', index_col=[0])
